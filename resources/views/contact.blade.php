        ...
        <x-layouts.container class="grid grid-cols-1 gap-12 lg:grid-cols-[760px_1fr] lg:gap-14 xl:gap-20">
            ...
            <div class="min-w-0 rounded-2xl bg-[rgba(17,15,6,0.26)] p-6 sm:p-10 lg:px-[56px] lg:py-[80px]">
                <form method="POST" action="{{ route('contact.submit') }}" class="flex flex-col gap-[44px]">
                    ...
                    <div class="flex flex-col">
                        <h1 class="text-4xl font-bold tracking-tight text-[#f38c00] lg:text-[46px]">Get in Touch</h1>
                        <p class="mt-1 text-xl font-medium tracking-tight text-white lg:text-[27px]">You can reach us anytime</p>
                    </div>

                    {{-- First / Last name --}}
                    <div class="flex flex-col gap-[22px] sm:flex-row">
                        <div class="flex flex-1 flex-col gap-[19px]">
                            <label for="first_name" class="text-[20px] font-medium tracking-tight text-white">First Name <span class="text-red-500">*</span></label>
                        ...
                        <div class="flex flex-1 flex-col gap-[19px]">
                            <label for="last_name" class="text-[20px] font-medium tracking-tight text-white">Last Name <span class="text-red-500">*</span></label>
                    ...
                    <div class="flex flex-col gap-[19px]">
                        <label for="email" class="text-[20px] font-medium tracking-tight text-white">Email <span class="text-red-500">*</span></label>
                    ...
                    {{-- Phone --}}
                    <div class="flex flex-col gap-[19px]">
                        <label for="phone" class="text-[20px] font-medium tracking-tight text-white">Phone Number</label>
                    ...
                    {{-- Message --}}
                    <div class="flex flex-col gap-[19px]">
                        <label for="message" class="text-[20px] font-medium tracking-tight text-white">How can we help?</label>
                    ...
                    <button type="submit"
                            class="mx-auto h-[68px] w-full max-w-[468px] rounded-[8px] bg-[#f38c00] text-[22px] font-medium text-white transition hover:bg-[#dd7f00]">
                        Submit
                    </button>
                </form>
            </div>
            ...
            <div class="flex min-w-0 flex-col gap-9">
                <div class="flex flex-col gap-[46px]">
                    <div class="flex flex-col gap-[21px]">
                        <div class="flex flex-col font-bold">
                            <p class="text-[20px] tracking-tight text-[#787878]">Let’s Start a Conversation</p>
                            <p class="text-4xl tracking-tight text-[#f38c00] lg:text-[58px] lg:leading-none">General Enquires</p>
                        </div>
                        <p class="text-[20px] font-medium leading-[29px] text-white">
                    ...
                    <div class="flex items-start gap-2">
                        <svg class="mt-0.5 size-[31px] shrink-0 text-[#f38c00]" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2a7 7 0 0 0-7 7c0 5.25 7 13 7 13s7-7.75 7-13a7 7 0 0 0-7-7zm0 9.5A2.5 2.5 0 1 1 12 6.5a2.5 2.5 0 0 1 0 5z"/></svg>
                        <p class="text-[20px] font-medium tracking-tight text-white">
                ...
                <div class="flex flex-col gap-4">
                    <p class="text-[24px] font-semibold tracking-tight text-[#d3d3d3]">Chat with us</p>
                    <a href="mailto:hello@retirodelrocio.com" class="flex items-center gap-2 transition hover:text-[#f38c00]">
                        <img src="{{ asset('images/mdi_email-open.png') }}" alt="" class="size-6 shrink-0 object-contain">
                        <span class="break-all text-[20px] font-medium tracking-tight text-white">hello@retirodelrocio.com</span>
                    </a>
                </div>

                {{-- Call us --}}
                <div class="flex flex-col gap-4">
                    <p class="text-[24px] font-semibold text-[#d3d3d3]">Call us</p>
                    <div class="flex flex-col gap-2">
                        <p class="text-[20px] text-[#d3d3d3] tracking-tight">Get in touch with us. Speak to one of our business reps</p>
                        <p class="text-[20px] text-[#d3d3d3]">Mon - Fri  from 9am - 4pm</p>
                        <a href="tel:+2347012623680" class="flex items-center gap-2 transition hover:text-[#f38c00]">
                            <svg class="size-[27px] shrink-0 text-[#f38c00]" viewBox="0 0 24 24" fill="currentColor"><path d="M6.6 10.8a15.5 15.5 0 0 0 6.6 6.6l2.2-2.2a1 1 0 0 1 1-.25 11.4 11.4 0 0 0 3.6.57 1 1 0 0 1 1 1V20a1 1 0 0 1-1 1A17 17 0 0 1 3 4a1 1 0 0 1 1-1h3.5a1 1 0 0 1 1 1c0 1.25.2 2.46.57 3.6a1 1 0 0 1-.25 1l-2.22 2.2z"/></svg>
                            <span class="text-[20px] font-medium tracking-tight text-white">(+234) 7012623680</span>
                        </a>
                    </div>
                </div>
                ...
                <div class="flex flex-col gap-[18px]">
                    <div class="flex flex-col gap-[11px] text-[#d3d3d3]">
                        <p class="text-[24px] font-semibold">Social media</p>
                        <p class="text-[20px] tracking-tight">Follow us on any of our socials to stay up-to-date</p>
                    </div>
    ...
    <section class="w-full py-16 lg:py-24">
        <x-layouts.container class="flex flex-col gap-[80px]">
            <div class="flex flex-col items-center gap-4 text-center">
                <h2 class="font-['Manrope'] text-3xl font-bold uppercase text-white lg:text-[42px]">Frequently Asked Questions</h2>
                <p class="text-[18px] capitalize text-[#e0e0e4] lg:text-[20px]">find answers to their most common questions quickly and easily.</p>
            </div>
                ...
                @foreach ($faqs as $i => $faq)
                    <div class="overflow-hidden rounded-[8px] border border-[#373d35] bg-[#1e2318]">
                        <button type="button" @click="open === {{ $i }} ? open = null : open = {{ $i }}"
                            ...
                            <span class="font-['Manrope'] text-[16px] tracking-wide text-white lg:text-[18px]">{{ $faq['q'] }}</span>
                            <svg class="size-6 shrink-0 text-white transition-transform duration-200" :class="{ 'rotate-45': open === {{ $i }} }" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M12 5v14M5 12h14"/></svg>
                        </button>
                        <div x-show="open === {{ $i }}" x-collapse x-cloak>
                            <p class="px-6 pb-5 font-['Manrope'] text-[15px] leading-relaxed text-[#e0e0e4] lg:text-[16px]">{{ $faq['a'] }}</p>
                        </div>
                    </div>
                @endforeach
            </div>
