        ...
        <div class="relative z-10 flex max-h-[90vh] w-full max-w-[480px] flex-col overflow-hidden rounded-2xl bg-white shadow-2xl">
            ...
            <div class="flex-1 overflow-y-auto px-6 py-5">
                ...
                <div class="mt-3 grid grid-cols-2 gap-3">
                    ...
                    <div class="rounded-xl border border-[#e5e7eb] bg-[#f9fafb] px-4 py-3"><p class="text-[11px] uppercase tracking-wide text-[#9ca3af]">Tickets</p><p class="mt-0.5 text-[13px] font-semibold text-[#1e1e1e]">{{ $selected->ticketTypeLabel() }}</p></div>
                    <div class="rounded-xl border border-[#e5e7eb] bg-[#f9fafb] px-4 py-3"><p class="text-[11px] uppercase tracking-wide text-[#9ca3af]">Seats</p><p class="mt-0.5 text-[13px] font-semibold text-[#1e1e1e]">{{ $selected->seatsLabel() }}</p></div>
